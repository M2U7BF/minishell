...
/*   Updated: 2025/07/28 10:44:36 by kkamei           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
# define ERR_EXIT_1 "minishell: exit: %s: numeric argument required\n"
...
// token_2.c
void							insert_token(t_token **first_token,
									t_token *token, t_token *add);
...
void							exec(t_i_mode_vars *i_vars,
									t_proc_unit *proc_list, int status);
...
// redirection.c
void							redirect(int *fd, int to_fd,
									t_list **redirect_fds);
...
char							**ft_multi_split_keep_sep(char *s,
									char *separator);

// ft_split_leave_separator.c
char							**ft_split_leave_separator(char *s,
									char separator);
...
char							**ft_splitarr_by_word_keep_sep(char **arr,
									char *separator);
